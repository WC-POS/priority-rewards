    ...
    if (isValid) {
      ...
      try {
        const res = await fetch(
          `https://${props.franchise.slug}.${process.env.NEXT_PUBLIC_API_HOST}/admin/auth/forgot/change/`,
          {
            method: "POST",
            headers: {
...
export async function getServerSideProps(context) {
  ...
  if (franchise && franchise.slug !== "admin") {
    if (context.query.codeId && context.query.email) {
      ...
      const url = `https://${slug}.${process.env.NEXT_PUBLIC_API_HOST}/admin/auth/forgot/check/${context.query.codeId}`;
